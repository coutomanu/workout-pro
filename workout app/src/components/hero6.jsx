            ...
            <div className="w-full px-4">
              <div className="hero-content text-center">
                <h1 className="mx-auto mb-3 max-w-[680px] text-4xl font-bold !leading-[1.208] text-black sm:text-4xl">
                  Controle seu Treino com um Assistente que tem Tudo o que você
                  precisa
                </h1>
                <p className="mx-auto mb-9 max-w-[480px] text-base text-black">
                  Conquiste o shape inexplicável em 60 dias com nosso assistente
                  que te auxilia quando você mais precisa.
                </p>
        ...
        >
          ...
          >
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/GaWr8PjF3Co?si=VIKhQR8jjo_H_Pul&amp;start=1"
